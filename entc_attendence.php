...
$conn = mysqli_connect('localhost', 'root', '', 'attendance');                $result = mysqli_query($conn,"select * from student where dept_id=3");
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="attendence_status[<?php echo $counter; ?>]" id="" value="present" required>Present 
                            <input type="radio" name="attendence_status[<?php echo $counter; ?>]" id="" value="absent" required>Not Present
                        </td>
